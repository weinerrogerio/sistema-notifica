...
namespace SistemaNotifica.src.Services
{
    ...
    public class ApiService
    {
        ...
        // ------------- MÉTODOS DE TEMPLATE (MOVER PARA TemplateService) ------------- //
        ...
        public async Task<List<EmailTemplate>> GetTemplatesAsync()
        {
            try
            {
                ...
                var response = await _sharedHttpClient.GetAsync($"{_baseUrl}/template");
                response.EnsureSuccessStatusCode();
                var json = await response.Content.ReadAsStringAsync();
        ...
        public async Task<EmailTemplate> GetTemplateAsync(int id)
        {
            try
            {
                ...
                var response = await _sharedHttpClient.GetAsync($"{_baseUrl}/template/{id}");
                response.EnsureSuccessStatusCode();
                var json = await response.Content.ReadAsStringAsync();
        ...
        public async Task<string> GetTemplateContentAsync(int id)
        {
            try
            {
                ...
                var response = await _sharedHttpClient.GetAsync($"{_baseUrl}/template/{id}/conteudo");
                response.EnsureSuccessStatusCode();
                return await response.Content.ReadAsStringAsync();
            }
            catch ( Exception ex )
        ...
        public async Task<EmailTemplate> GetTemplatePadraoAsync()
        {
            try
            {
                ...
                var response = await _sharedHttpClient.GetAsync($"{_baseUrl}/template/padrao");
                response.EnsureSuccessStatusCode();
                var json = await response.Content.ReadAsStringAsync();
        ...
        public async Task<EmailTemplate> UploadTemplateAsync(byte[] fileBytes, string nomeArquivo, string descricao = null)
        {
            try
            {
                ...
                using ( var form = new MultipartFormDataContent() )
                {
                    ...
                    var response = await _sharedHttpClient.PostAsync($"{_baseUrl}/template/upload", form);
                    response.EnsureSuccessStatusCode();
        ...
        public async Task SetTemplatePadraoAsync(int id)
        {
            try
            {
                ...
                var response = await _sharedHttpClient.PostAsync($"{_baseUrl}/template/{id}/set-padrao", null);
                response.EnsureSuccessStatusCode();
            }
            catch ( Exception ex )
            {
        ...
        public async Task DeleteTemplateAsync(int id)
        {
            try
            {
                ...
                var response = await _sharedHttpClient.DeleteAsync($"{_baseUrl}/template/{id}");
                response.EnsureSuccessStatusCode();
            }
            catch ( Exception ex )
            {
